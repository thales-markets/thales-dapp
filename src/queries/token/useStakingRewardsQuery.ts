    ...
    return useQuery<StakingReward>(
        ...
        async () => {
            ...
            const stakingRewards: StakingReward = {
                ...
                snxBonus: (bigNumberFormatter(baseRewards) * Number(snxBonus)) / 100,
                ammBonus: (bigNumberFormatter(baseRewards) * Number(ammBonus)) / 100,
                thalesRoyaleBonus: (bigNumberFormatter(baseRewards) * Number(thalesRoyaleBonus)) / 100,
