...
const ThalesBalanceTooltip: React.FC<Properties> = ({ setThalesTotalBalance }) => {
    ...
    return (
        <>
            <FlexDivSpaceBetween>
                <BalanceTitle>{t('common.wallet.in-wallet')}:</BalanceTitle>
                <BalanceValue>{formatCurrencyWithKey(THALES_CURRENCY, thalesBalance)}</BalanceValue>
            </FlexDivSpaceBetween>
            <FlexDivSpaceBetween>
                <BalanceTitle>{t('common.wallet.total-staked')}:</BalanceTitle>
                <BalanceValue>{formatCurrencyWithKey(THALES_CURRENCY, thalesStaked)}</BalanceValue>
            </FlexDivSpaceBetween>
            <FlexDivSpaceBetween>
                <BalanceTitle>{t('common.wallet.total-escrowed')}:</BalanceTitle>
