...
import { TRANSACTION_STATUS, DEFAULT_GAS_LIMIT } from 'constants/transaction';
    ...
    switch (action.type) {
        ...
        case SET_NETWORK_GAS_INFO: {
            ...
            return {
                ...state,
                gasSpeed,
                gasPrice: currentGasPrice > gasSpeed['fastestAllowed'] ? gasSpeed['fastestAllowed'] : currentGasPrice,
            };
        }
