...
export const limitOrderProtocol1inchContract = {
    addresses: {
        [NetworkId.Mainnet]: '0x3ef51736315f52d568d6d2cf289419b9cfffe782',
    ...
    abi: [
        ...
        {
            inputs: [
                { internalType: 'contract AggregatorV3Interface', name: 'oracle1', type: 'address' },
                { internalType: 'contract AggregatorV3Interface', name: 'oracle2', type: 'address' },
        ...
        {
            inputs: [
                { internalType: 'uint256', name: 'orderMakerAmount', type: 'uint256' },
                { internalType: 'uint256', name: 'orderTakerAmount', type: 'uint256' },
                { internalType: 'uint256', name: 'swapTakerAmount', type: 'uint256' },
            ],
            name: 'getMakerAmount',
            outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
        ...
        },
        {
            inputs: [
                { internalType: 'uint256', name: 'orderMakerAmount', type: 'uint256' },
                { internalType: 'uint256', name: 'orderTakerAmount', type: 'uint256' },
                { internalType: 'uint256', name: 'swapMakerAmount', type: 'uint256' },
            ],
            name: 'getTakerAmount',
            outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
            stateMutability: 'pure',
        ...
        },
        {
            inputs: [
                ...
                { internalType: 'uint256', name: 'inverseAndSpread', type: 'uint256' },
                { internalType: 'uint256', name: 'amount', type: 'uint256' },
            ],
            name: 'singlePrice',
            outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
...
export default limitOrderProtocol1inchContract;
