...
export const stakingDataContract = {
    addresses: {
        ...
        [Network.Kovan]: 'TBD',
        [Network.Goerli]: 'TBD',
        [Network['Mainnet-Ovm']]: '0xCc134245424fe9E10A011961451D5AD6Cd0C087C',
        [Network['Kovan-Ovm']]: 'TBD',
        [Network['Goerli-Ovm']]: '0x87005978e76C7356D1e0a8118DC82eaF52D49FB1',
            ...
            outputs: [
                {
                    components: [
                        ...
                        { internalType: 'uint256', name: 'maxSNXRewardsPercentage', type: 'uint256' },
                        { internalType: 'uint256', name: 'maxAMMVolumeRewardsPercentage', type: 'uint256' },
                        { internalType: 'uint256', name: 'maxThalesRoyaleRewardsPercentage', type: 'uint256' },
                        { internalType: 'uint256', name: 'SNXVolumeRewardsMultiplier', type: 'uint256' },
                        { internalType: 'uint256', name: 'AMMVolumeRewardsMultiplier', type: 'uint256' },
            ...
            outputs: [
                {
                    components: [
                        ...
                        { internalType: 'uint256', name: 'snxBonus', type: 'uint256' },
                        { internalType: 'uint256', name: 'ammBonus', type: 'uint256' },
                        { internalType: 'uint256', name: 'snxStaked', type: 'uint256' },
                        { internalType: 'uint256', name: 'ammVolume', type: 'uint256' },
                        { internalType: 'uint256', name: 'thalesAmmVolume', type: 'uint256' },
                        { internalType: 'uint256', name: 'rangedAmmVolume', type: 'uint256' },
                        { internalType: 'uint256', name: 'sportsAmmVolume', type: 'uint256' },
