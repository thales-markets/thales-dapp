        ...
        if (isAA) {
            if (isBuy) {
                return await executeBiconomyTransaction(
                    ...
                    [marketAddress, side, parsedAmount, parsedTotal, parsedSlippage]
                );
            } else {
                return await executeBiconomyTransaction(collateral as string, ammContractWithSigner, 'sellToAMM', [
                    marketAddress,
                    side,
                    parsedAmount,
                    parsedTotal,
