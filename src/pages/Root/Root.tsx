...
import App from './App';
import { base, opBnbTestnet } from 'constants/network';
...
const CHAIN_TO_RPC_PROVIDER_NETWORK_NAME: Record<number, RpcProvider> = {
    ...
    [Network.OpBnbTestnet]: { ankr: '', chainnode: '', blast: '' },
};

const STALL_TIMEOUT = 2000;

const { chains, provider } = configureChains(
    [optimism, optimismGoerli, mainnet, polygon, arbitrum, bsc, base, opBnbTestnet],
    [
        jsonRpcProvider({
            rpc: (chain) => ({
