...
const AmmSpeedTrading: React.FC<AmmSpeedTradingProps> = ({
    ...
    const isFormDisabled = isSubmitting; // TODO:
    const isButtonDisabled = positionType === undefined || !(strikeTime || deltaTimeSec) || !paidAmount || isSubmitting; // TODO:
    ...
    }, [paidAmount, stableBalance, t, isWalletConnected]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (speedMarketsAMMContract) {
                ...
                const tx: ethers.ContractTransaction = strikeTime
