...
const WalletBalance: React.FC<WalletBalancePropsType> = ({ type, marketAddress, stableIndex }) => {
    ...
    const rangedMarketsBalance = useRangedMarketPositionBalanceQuery(marketAddress, walletAddress, networkId, {
