...
const AMM: React.FC<RangedAMMProps> = ({ marketAddress, inAddress, outAddress }) => {
    ...
    const positionBalanceQuery = useRangedMarketPositionBalanceQuery(marketAddress, walletAddress, networkId, {
    ...
    const ammMaxLimitsQuery = useRangedAMMMaxLimitsQuery(marketAddress, networkId, {
        enabled: isAppReady,
    });
    const ammMaxLimits =
            ...
            try {
                ...
                if (isSubmit) {
                    ...
                    if (
                        ...
                        fetchGasLimit(marketAddress, RANGE_SIDE[rangeSide], parsedAmount, ammQuote, parsedSlippage);
                    }
                }
