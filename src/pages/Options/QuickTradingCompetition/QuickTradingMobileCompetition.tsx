...
import { TradingModeFilterEnum, OrderFilterEnum, CoinFilterEnum, OptionFilterEnum } from './QuickTradingCompetition';
...
const QuickTradingCompetitionMobile: React.FC<QuickTradingMobileProps> = ({
    orders,
    tradingModeFilter,
    orderFilter,
    coinFilter,
...
export default QuickTradingCompetitionMobile;
