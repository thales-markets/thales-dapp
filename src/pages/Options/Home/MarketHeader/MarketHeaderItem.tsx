...
type MarketHeaderItemProps = MenuItem & { submenuItems?: MenuItem[] };

const MarketHeaderItem: React.FC<MarketHeaderItemProps> = ({ href, className, iconName, label, submenuItems }) => {
...
export default MarketHeaderItem;
