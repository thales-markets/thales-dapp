...
export const ExploreMarketsMobile: React.FC<ExploreMarketsProps> = ({ optionsMarkets, exchangeRates, olympics }) => {
    ...
    return (
        <div className="markets-mobile" style={{ padding: '0 150px 50px 150px', width: '100%' }}>
            <SearchMarket
