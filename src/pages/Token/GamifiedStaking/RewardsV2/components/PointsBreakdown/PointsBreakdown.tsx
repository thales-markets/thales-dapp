                                ...
                                <LinksContainer>
                                    <LinkWrapper href={buildHref(ROUTES.Options.Home)} target="_blank" rel="noreferrer">
                                        ...
                                        <LinkLabelContainer>
                                            ...
                                            <ExternalIcon className="icon icon--external" />
                                        </LinkLabelContainer>
                                    </LinkWrapper>
                                    <LinkWrapper
                                    ...
                                    <VaultsWrapper>
                                        ...
                                        <LinksContainer>
                                            ...
                                            <LinkWrapper
                                                ...
                                                rel="noreferrer"
                                            >
                                                <LinkIcon className="icon icon--degen-vault" />
                                                <LinkLabelContainer>
                                                    <LinkLabel>
                                                        {t(
                                            ...
                                            <LinkWrapper
                                                ...
                                                rel="noreferrer"
                                            >
                                                <LinkIcon className="icon icon--safu-overtime" />
                                                <LinkLabelContainer>
                                                    <LinkLabel>
                                                        {t(
                                                            'thales-token.gamified-staking.rewards.breakdown-section.volume-gathered.safu-vault'
                                            ...
                                            <LinkWrapper
                                                ...
                                                rel="noreferrer"
                                            >
                                                <LinkIcon className="icon icon--parlay-vault" />
                                                <LinkLabelContainer>
                                                    <LinkLabel>
                                                        {t(
