                        ...
                        (n.prototype.push = function (e, t) {
                            ...
                            do {
                                ...
                                f.next_out &&
                                    ((0 !== f.avail_out &&
                                        r !== d.Z_STREAM_END &&
                                        (0 !== f.avail_in || (n !== d.Z_FINISH && n !== d.Z_SYNC_FLUSH))) ||
                            ...
                            return (
                                ...
                                n === d.Z_FINISH
                                    ? ((r = i.inflateEnd(this.strm)), this.onEnd(r), (this.ended = !0), r === d.Z_OK)
                                    : n !== d.Z_SYNC_FLUSH || (this.onEnd(d.Z_OK), (f.avail_out = 0), !0)
                            );
                        }),
                    ...
                    'zlib/inflate.js': function (e, t, r) {
                            ...
                            return (
                                ...
                                n >= a.wsize
                                    ...
                                    : ((o = a.wsize - a.wnext),
                                      ...
                                      (n -= o),
                                      n
                                          ? (g.arraySet(a.window, t, r - n, n, 0), (a.wnext = n), (a.whave = a.wsize))
                                          : ((a.wnext += o),
                        ...
                        function f(e, t) {
                                ...
                                switch (r.mode) {
                                    ...
                                    case ne:
                                        ...
                                        if (we && 0 === (240 & we)) {
                                            for (
                                                ve = me, ye = we, ke = ge;
                                                (Ce = r.lencode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]),
                                                    (me = Ce >>> 24),
                                                    (we = (Ce >>> 16) & 255),
                                                    (ge = 65535 & Ce),
                                                    !(ve + me <= h);
                                    ...
                                    case ae:
                                        ...
                                        if (0 === (240 & we)) {
                                            for (
                                                ve = me, ye = we, ke = ge;
                                                (Ce = r.distcode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]),
                                                    (me = Ce >>> 24),
                                                    (we = (Ce >>> 16) & 255),
                                                    (ge = 65535 & Ce),
                                                    !(ve + me <= h);
                            ...
                            return (
                                ...
                                (r.hold = f),
                                (r.bits = h),
                                (r.wsize || (b !== e.avail_out && r.mode < fe && (r.mode < de || t !== C))) &&
                        ...
                        function p(e, t) {
                            var r;
                            return e && e.state
                                ? ((r = e.state), 0 === (2 & r.wrap) ? O : ((r.head = t), (t.done = !1), R))
                                : O;
                        }
                        function b(e, t) {
                            var r,
                            ...
                            return e && e.state
                                ? ((r = e.state),
                                  0 !== r.wrap && r.mode !== X
                                      ? O
                                      : r.mode === X && ((n = 1), (n = v(n, t, a, 0)), n !== r.check)
                                      ? H
                                      : (o = c(e, t, a, a))
                                      ? ((r.mode = he), A)
                                      : ((r.havedict = 1), R))
                    ...
                    'zlib/inffast.js': function (e, t, r) {
                        ...
                        t.exports = function (e, t) {
                            ...
                            e: do {
                                ...
                                t: for (;;) {
                                    if (((x = k >>> 24), (b >>>= x), (m -= x), (x = (k >>> 16) & 255), 0 === x))
                                        T[s++] = 65535 & k;
                                    else {
                                        if (!(16 & x)) {
                                            if (0 === (64 & x)) {
                    ...
                    'zlib/inftrees.js': function (e, t, r) {
                        ...
                        t.exports = function (e, t, r, p, b, m, w, g) {
                            var v,
                                ...
                                W = 0;
                            for (R = 0; R <= o; R++) Z[R] = 0;
                            for (L = 0; L < p; L++) Z[t[r + L]]++;
                            for (H = T, O = o; O >= 1 && 0 === Z[O]; O--);
                            if ((H > O && (H = O), 0 === O))
                                return (b[m++] = 20971520), (b[m++] = 20971520), (g.bits = 1), 0;
                            for (B = 1; B < O && 0 === Z[B]; B++);
                            for (H < B && (H = B), N = 1, R = 1; R <= o; R++)
                                if (((N <<= 1), (N -= Z[R]), N < 0)) return -1;
                            if (N > 0 && (e === s || 1 !== O)) return -1;
                            for (M[1] = 0, R = 1; R < o; R++) M[R + 1] = M[R] + Z[R];
                            for (L = 0; L < p; L++) 0 !== t[r + L] && (w[M[t[r + L]]++] = L);
                            if (
                                (e === s
                                    ? ((F = j = w), (S = 19))
                                    : e === l
                            ...
                            for (;;) {
                                ...
                                while (0 !== y);
                                for (v = 1 << (R - 1); z & v; ) v >>= 1;
                                if ((0 !== v ? ((z &= v - 1), (z += v)) : (z = 0), L++, 0 === --Z[R])) {
                                    if (R === O) break;
                                    R = t[r + w[L]];
                                }
                                if (R > H && (z & x) !== k) {
                                    for (
                                        0 === I && (I = H), _ += B, A = R - I, N = 1 << A;
                                        A + I < O && ((N -= Z[A + I]), !(N <= 0));
                            ...
                            return 0 !== z && (b[_ + z] = ((R - I) << 24) | (64 << 16) | 0), (g.bits = H), 0;
                        };
                    },
                };
        ...
        f.SystemInfo.hasWebGL
            ? f.SystemInfo.hasWasm
                ? (1 == f.SystemInfo.hasWebGL &&
                      f.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'),
